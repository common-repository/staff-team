  ...
  /*      .twd_shortcode .twd_shortcode_menu span:focus{
    ...
    <script>
        ...
        function ecwd_generate_ecwd_shortcode(data) {
            ...
            var data_view = jQuery(".twd_shortcode_menu .twd_active").data("view");
            var twd_shortcode = false;
            if(data_view === "twd_single_content"){
              if(twd_contact !== "select_cat") {
                twd_shortcode = '[Staff_Directory_WD  id="' + twd_contact + '" ]';
              }
            }else if(data_view === "twd_contacts_category"){
              if(twd_cat!==""){
                twd_shortcode = '[Staff_Directory_WD  cats="'+twd_cat+'" type="'+twd_shortcode_view+'" ]';
              }
            }
