...
<?php function sc_uninstall(){?>
  ...
  <form class="sc_form" method="post" action="admin.php?page=uninstall_plugin" style="width:99%;">
    ...
    <div class="wrap">
      ...
      <h2><?php echo __('Uninstall Team by 10Web', 'sc_back'); ?></h2>
      <p>
        <?php echo __('Deactivating Team by 10Web plugin does not remove any data that may have been created. To completely remove this plugin, you can uninstall it here.', 'sc_back'); ?>
      </p>
      <p style="color: red;">
      ...
      <p style="text-align: center;">
        <?php echo __('Do you really want to uninstall Team by 10Web?', 'sc_back'); ?>
      </p>
      <p style="text-align: center;">
      ...
      <p style="text-align: center;">
        <input type="submit" name="sc_uninstall" value="UNINSTALL" class="button-primary" onclick="if (check_yes.checked) {
            if (confirm('<?php echo addslashes(__('You are About to Uninstall Team by 10Web from WordPress. This Action Is Not Reversible.', 'sc_back')); ?>')) {
...
<?php function sc_uninstall_success(){?>
  ...
  <div class="wrap">
    <h2><?php echo __('Uninstall Team by 10Web', 'bwg_back'); ?></h2>
    <!--<p><strong><a href="?page=uninstall_plugin&deactivate_plugin=true"><?php /*echo __('Click Here', 'bwg_back'); */?></a> <?php /*echo __('To Finish the Uninstallation and Team by 10Web will be Deactivated Automatically.', 'bwg_back'); */?></strong></p>-->
    <p><strong><a href="#" class="twd_deactivate_link" data-uninstall="1"><?php _e("Click Here","twd"); ?></a><?php _e(" To Finish the Uninstallation and Team by 10Web will be Deactivated Automatically.","twd"); ?></strong></p>
