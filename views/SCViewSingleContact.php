                            ...
                            <div class="img_content">
                              <?php if ($has_image || $noImage==""){ ?>
                                  <a href="<?php  if(isset($attach_url['full'])){echo $attach_url['full'];} ?>" <?php if(get_option('lightbox')) echo 'rel="contact_lightbox"';else echo 'target="_blank"';?> class="cont_main_picture_a" style="text-decoration:none;">
                                      <span class="single_cont_main_picture" role="img" aria-label="<?php echo get_the_title($post->ID); ?>" style="display:block; background-image: url('<?php echo $attach_url['thumb']; ?>');">
                                          <img src="<?php echo $attach_url['thumb']; ?>" alt="<?php echo get_the_title($post->ID); ?>" id="imagelightbox" style="display:none;"/>
                                      </span>
                                  </a>
                              <?php } else{  ?>
